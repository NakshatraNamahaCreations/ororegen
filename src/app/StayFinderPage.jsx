...
const Home = () => {
  ...
  const openStore = useCallback((url) => {
    try {
  ...
  const screenshots = useMemo(
    () => [scr1, scr2, scr3, scr4, scr5, scr7, scr8, scr9, scr10],
    []
  );
  ...
  // Sliders (kept desktop behavior, tuned for phones)
  const cardSliderSettings = useMemo(
    () => ({
      dots: true,
      infinite: true,
      speed: 600,
      ...
      responsive: [
        ...
        { breakpoint: 768, settings: { slidesToShow: 1, arrows: false } }, // cleaner on phones
      ],
    }),
    []
  );

  const screenshotsSettings = useMemo(
    () => ({
      dots: false,
      infinite: true,
      speed: 750,
    ...
    <>
      ...
      <section
        ...
        style={{
          ...
          justifyContent: "center",
          textAlign: "center",
          marginTop: isMobile ? "90px" : "200px", // keep desktop look
          padding: isMobile ? "84px 16px 60px" : "0px",
          fontFamily: '"Poppins", sans-serif',
          overflow: "hidden",
        }}
      >
        {/* Mobile veil for readability */}
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: isMobile
              ? "linear-gradient(to bottom, rgba(255,255,255,0.9), rgba(255,255,255,0.65))"
              : "none",
          }}
        />
        <div
        ...
        >
          <h1
            style={{
              ...
              color: "#ff385c",
              marginBottom: 14,
              marginTop: isMobile ? 0 : "-400px", // preserve desktop hero offset
              lineHeight: 1.2,
              letterSpacing: isMobile ? "0.2px" : 0,
            }}
          >
          ...
          >
            <button
              ...
              onClick={() =>
                openStore("https://play.google.com/store/apps/details?id=com.yourapp")
              }
            ...
            <button
              ...
              onClick={() => openStore("https://apple.com/app-store/")}
              style={{ border: "none", background: "transparent", padding: 0, cursor: "pointer" }}
            >
              <img
                src={appStoreImg}
      ...
      >
        <div style={{ flex: 1, display: "flex", justifyContent: "center" }}>
          <img
            ...
            alt="About StayFind"
            loading="lazy"
            style={{ width: isMobile ? "100%" : "150%", maxWidth: 700, height: "auto" }}
          />
        </div>
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: isMobile ? "1rem" : "1.1rem", lineHeight: 1.6, color: "#444" }}>
            At StayFindr, we make travel easy and affordable. Whether you need a cozy room for a
            weekend getaway, a business trip, or a long vacation, our platform helps you discover
            verified stays with just a few clicks.
          </p>
        </div>
      </section>
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 250 }}>
            {[
              ...
              >
                <div style={{ fontSize: isMobile ? 34 : 40, color: "#FF385C", marginBottom: 12 }}>
                  {r.icon}
                </div>
                <h3 style={{ fontSize: "1.15rem", fontWeight: 600 }}>{r.title}</h3>
                <p style={{ color: "#555" }}>{r.text}</p>
          ...
          {/* Center (phone mock) */}
          <div style={{ flex: 1, minWidth: 320, position: "relative", textAlign: "center" }}>
            <img
              src={phoneFrame}
              alt="Phone Frame"
              loading="lazy"
          ...
          <div style={{ flex: 1, minWidth: 250 }}>
            {[
              ...
              >
                <div style={{ fontSize: isMobile ? 34 : 40, color: "#FF385C", marginBottom: 12 }}>{r.icon}</div>
                <h3 style={{ fontSize: "1.15rem", fontWeight: 600 }}>{r.title}</h3>
                <p style={{ color: "#555" }}>{r.text}</p>
              </div>
            ))}
      ...
      >
        {/* Left Content */}
        <div style={{ flex: 1, minWidth: 280, paddingLeft: isMobile ? 0 : 40 }}>
          <span
            style={{
              background: "#fff",
              color: "#FF385C",
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            >
              <img
                ...
                alt="Google Play"
                loading="lazy"
                style={{ height: 44, width: 170, background: "black", padding: 10, borderRadius: 12 }}
              />
            </button>
            <button
              onClick={() => openStore("https://apple.com/app-store/")}
        ...
        {/* Right Content placeholder (kept empty) */}
        <div
          style={{
            flex: 1,
            minWidth: 300,
      ...
      >
        ...
        <Slider {...cardSliderSettings}>
          {testimonials.map((t, i) => (
            <div key={i} style={{ padding: isMobile ? 12 : 20 }}>
              <div
                style={{
                  background: "#fff",
                  borderRadius: 15,
      ...
      <section
        style={{
          padding: isMobile ? "40px 16px" : "0px 20px",
          textAlign: "center",
          position: "relative",
          fontFamily: '"Poppins", sans-serif',
        }}
      >
        ...
        <div style={{ position: "relative", maxWidth: 1000, margin: "0 auto", overflow: "hidden" }}>
          <Slider {...screenshotsSettings}>
            {screenshots.map((s, i) => (
              <div key={i} style={{ padding: isMobile ? "0 8px" : "0 10px" }}>
                <img
                  src={s}
                  alt={`Screenshot ${i + 1}`}
                  loading="lazy"
        ...
        {faqs.map((faq, index) => {
          ...
          return (
            ...
            >
              ...
              {isOpen && <p style={{ marginTop: 10, color: "#444" }}>{faq.a}</p>}
            </div>
          );
        })}
      </section>
