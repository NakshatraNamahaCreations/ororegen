  ...
  return (
    <>
      ...
      {!isMobile ? (
        ...
        // Mobile: text first, then banner image
        <section
          id="home"
          style={{
            marginTop: "90px",
      ...
      <section
        id="whychooseus"
        style={{
          padding: isMobile ? "36px 16px" : "100px 20px",
          background: "#fff",
          textAlign: "center",
          fontFamily: '"Poppins", sans-serif',
        }}
      >
        ...
        <p
          style={{
            fontSize: isMobile ? "1rem" : "1.1rem",
            color: "#666",
            marginBottom: isMobile ? "28px" : "70px",
            maxWidth: "700px",
            margin: "0 auto",
          }}
        >
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 320, position: "relative", textAlign: "center" }}>
              <img
                src={phoneFrame}
                alt="Phone Frame"
                style={{ height: "600px", margin: "0 auto", position: "relative", zIndex: 2 }}
              />
              <img
                src={scr4}
                alt="StayFind App"
      ...
      >
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto 8px" }}>
      ...
      <section
        style={{
          ...
          padding: isMobile ? "28px 18px" : "70px 80px",
          display: "flex",
          alignItems: "center",
          justifyContent: "space-between",
          flexWrap: "wrap",
      ...
      <section id="faq" style={{ padding: isMobile ? "50px 16px" : "60px 20px", maxWidth: 900, margin: "0 auto" }}>
        ...
        {faqs.map((faq, index) => (
          ...
          >
            ...
            {openIndex === index && <p style={{ marginTop: 10, color: "#444" }}>{faq.a}</p>}
          </div>
        ))}
      </section>
