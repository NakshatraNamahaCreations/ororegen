...
const Home = () => {
  ...
  const faqs = [
    { q: "How do I book a room on StayFind?", a: "Simply search your destination, choose from available stays, and confirm your booking online." },
    ...
    <>
      ...
      <section style={{
        ...
        {[
          ...
          <div key={i} style={{
            flex: "1 1 250px", maxWidth: "280px", background: "rgba(255,255,255,0.15)",
            padding: "20px", borderRadius: "15px", textAlign: "center",
            boxShadow: "0 6px 20px rgba(0,0,0,0.08)", color: "#fff"
          }}>
      ...
      <section id="about" style={{
        ...
        padding: "60px 40px", gap: "40px", maxWidth: "1200px", margin: "0 auto"
      }}>
      ...
      <section id="whychooseus" style={{
        ...
        <div style={{
          ...
          gap: "40px", flexWrap: "wrap", maxWidth: "1200px", margin: "0 auto"
        }}>
          {/* Left */}
          <div style={{ flex: 1, minWidth: 250 }}>
            ...
            { title: "Verified Listings", text: "Every stay is checked for quality.", icon: <FaCheckCircle /> }]
              .map((r, i) => (
                <div key={i} style={{
                  background: "#fff", borderRadius: "12px", padding: "25px", marginBottom: "30px",
                  textAlign: "left", boxShadow: "0 6px 20px rgba(0,0,0,0.08)"
                }}>
                  <div style={{ fontSize: 40, color: "#FF385C", marginBottom: 15 }}>{r.icon}</div>
                  <h3 style={{ fontSize: "1.2rem", fontWeight: 600 }}>{r.title}</h3>
          ...
          {/* Center */}
          <div style={{ flex: 1, minWidth: 350, position: "relative", textAlign: "center" }}>
            <img src={phoneFrame} alt="Phone Frame" style={{
              height: "600px", margin: "0 auto", position: "relative", zIndex: 2
            }} />
            <img src={scr4} alt="StayFind App" style={{
              position: "absolute", top: "50%", left: "50%",
              transform: "translate(-50%, -50%)", height: "470px", borderRadius: "30px", zIndex: 1
            }} />
          </div>
      ...
      {/* ===== FAQs ===== */}
      <section id="faq" style={{ padding: "60px 20px", maxWidth: 900, margin: "0 auto" }}>
        <h2 style={{ fontSize: "2.5rem", fontWeight: "bold", textAlign: "center", marginBottom: "40px", color: "#222" }}>❓ FAQs</h2>
        {faqs.map((faq, index) => (
          <div key={index} style={{
            marginBottom: "15px", padding: "20px", borderRadius: "8px",
            background: "#f9f9f9", boxShadow: "0 4px 10px rgba(0,0,0,0.08)"
          }} onClick={() => setOpenIndex(openIndex === index ? null : index)}>
            <div style={{
              fontSize: "1.2rem", fontWeight: 600, color: "#ff385c",
              display: "flex", justifyContent: "space-between"
            }}>
              {faq.q} <span>{openIndex === index ? "−" : "+"}</span>
            </div>
            {openIndex === index && <p style={{ marginTop: "10px", color: "#444" }}>{faq.a}</p>}
          </div>
        ))}
      </section>
