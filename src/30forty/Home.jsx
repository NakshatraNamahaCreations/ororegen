...
//           </h1>
//           <p style={{ fontSize: "18px", lineHeight: "1.6", color: "#f1f1f1" ,  fontFamily: '"Poppins", sans-serif',}}>
...
//             </h2>
//             <p style={{ color: "#444", fontSize: "16px", lineHeight: "1.8" ,  fontFamily: '"Poppins", sans-serif',}}>
...
//       <section
//         id="faq"
//         style={{ padding: "80px 20px", backgroundColor: "#fff",  fontFamily: '"Poppins", sans-serif', }}
//       >
//         <div style={{ textAlign: "center", marginBottom: "50px" ,  fontFamily: '"Poppins", sans-serif',}}>
//           <h2
//             style={{
//               fontSize: "32px",
//               fontWeight: "800",
...
//           {/* Left Info */}
//           <div>
//             <h3 style={{ color: "#d1001f", fontWeight: 700,  fontFamily: '"Poppins", sans-serif', }}>📍 Address</h3>
//             <p>#36 A-WING, 2ND MAIN, SRINAGARA BADAVANE, SRINAGARA, MYSORE-570008</p>

//             <h3 style={{ color: "#d1001f", fontWeight: 700, marginTop: "20px",  fontFamily: '"Poppins", sans-serif', }}>
//               📞 Call
//             </h3>
//             <p>+91 73495 79436</p>
