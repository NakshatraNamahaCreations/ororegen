...
function Home() {
  ...
  return (
    <div style={{ scrollBehavior: "smooth" }}>
          ...
          >
            {points.map((item, i) => (
              ...
              >
                {item.icon}
                <h3 style={{ margin: "10px 0 6px" }}>{item.title}</h3>
                <p style={{ color: "#555", fontSize: isMobile ? 14 : 16 ,    fontFamily: "'Poppins', sans-serif",}}>
                  {item.text}
                </p>
              </div>
            ))}
            ...
            >
              ...
              {points.map((p, i) => (
                <div key={i} style={{ display: "flex", marginBottom: 16 }}>
                  ...
                  <div>
                    <h3 style={{ margin: 0, fontSize: 18 }}>{p.title}</h3>
                    <p style={{ margin: "4px 0 0", color: "#555",    fontFamily: "'Poppins', sans-serif", }}>{p.text}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto",    fontFamily: "'Poppins', sans-serif", }}>
          {faqs.map((faq, i) => (
            ...
            >
              ...
              {openIndex === i && (
                <p style={{ color: "#555", lineHeight: 1.6, fontSize: isMobile ? 14 : 16,    fontFamily: "'Poppins', sans-serif", }}>
                  {faq.answer}
                </p>
              )}
            </div>
      ...
      {/* ✅ Download Section (SMALLER ON MOBILE, SAME ON DESKTOP) */}
      <section
        id="download"
        style={{
          backgroundImage: `url(${downloadBg})`,
          ...
          margin: isMobile ? "20px 12px" : "0",
              fontFamily: "'Poppins', sans-serif",
        }}
      >
        <div
          style={{
            maxWidth: isMobile ? "680px" : "1200px",
            margin: "0 auto",
          }}
        >
          <h2
